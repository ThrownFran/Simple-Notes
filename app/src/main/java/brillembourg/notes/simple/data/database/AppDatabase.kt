...
@Database(
    entities = [NoteEntity::class, CategoryEntity::class, CategoryNoteCrossRef::class],
    version = 10,
)
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_5_to_6: Migration =
        ...
        private val MIGRATION_6_to_7: Migration =
            object : Migration(6, 7) {
                @Suppress("ktlint:standard:max-line-length")
                override fun migrate(database: SupportSQLiteDatabase) {
                    database.execSQL(
                        "CREATE TABLE IF NOT EXISTS `categoryentity` (`id` INTEGER, `name` TEXT NOT NULL, `order` INTEGER NOT NULL, PRIMARY KEY(`id`))",
                    )
                }
            }

        private val MIGRATION_7_to_8: Migration =
        ...
        private val MIGRATION_8_to_9: Migration =
            object : Migration(8, 9) {
                @Suppress("ktlint:standard:max-line-length")
                override fun migrate(database: SupportSQLiteDatabase) {
                    database.execSQL(
                        "CREATE TABLE IF NOT EXISTS `category_note_cross_ref` (`category_id` INTEGER NOT NULL, `note_id` INTEGER NOT NULL, PRIMARY KEY(`category_id`, `note_id`))",
                    )
                }
            }

        private val MIGRATION_9_to_10: Migration =
            object : Migration(9, 10) {
                @Suppress("ktlint:standard:max-line-length")
                override fun migrate(database: SupportSQLiteDatabase) {
                    database.execSQL(
                        "CREATE TABLE IF NOT EXISTS `category_note_cross_ref_copy` (`category_id` INTEGER NOT NULL, `note_id` INTEGER NOT NULL, PRIMARY KEY(`category_id`, `note_id`), FOREIGN KEY(`category_id`) REFERENCES `categoryentity`(`category_id`) ON UPDATE NO ACTION ON DELETE CASCADE, FOREIGN KEY(`note_id`) REFERENCES `taskentity`(`note_id`) ON UPDATE NO ACTION ON DELETE CASCADE )",
                    )
