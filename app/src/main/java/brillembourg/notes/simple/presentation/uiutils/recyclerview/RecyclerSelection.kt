package brillembourg.notes.simple.presentation.uiutils
...
interface Selectable<T : IsSelectable> {
     ...
     *
     * @param bindSelection Use to bind selected or unselected item
     * @param onClickWithNoSelection Normal click item with disabled selection
     * @param onSelected When selecting or unselecting item
     * @param onReadyToDrag Start drag suggestion
     */
    fun setupSelection(
...
class SelectableImp<T : IsSelectable>(
    ...
    private fun isSelectionVisible(): Boolean = getCurrentList().any { it.isSelected }
