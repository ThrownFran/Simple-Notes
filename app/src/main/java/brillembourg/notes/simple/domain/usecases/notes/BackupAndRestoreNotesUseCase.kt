package brillembourg.notes.simple.domain.usecases.notes
...
class BackupAndRestoreNotesUseCase
    @Inject
    constructor(private val repository: BackupAndRestoreRepository) {
