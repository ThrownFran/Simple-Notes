...
interface TaskRepository {
    ...
    suspend fun unArchiveTasks(params: UnArchiveTasksUseCase.Params): Resource<UnArchiveTasksUseCase.Result>
    suspend fun deleteTask(params: DeleteTasksUseCase.Params): Resource<DeleteTasksUseCase.Result>
    fun getTaskList(params: GetTaskListUseCase.Params): Flow<Resource<GetTaskListUseCase.Result>>
    fun getArchivedTasks(params: GetArchivedTasksUseCase.Params): Flow<Resource<GetArchivedTasksUseCase.Result>>
}